...
public class ModdedPlayerCharacterController : MonoBehaviour
{
    [Header("References")]
    ...
    [Header("Gravity")]
    [Tooltip("Current gravity Object")]
    public GravityOrbit gravityField;
    [Tooltip("Force applied downward when in the air")]
    public float gravityDownForce = 20f;
    [Tooltip("Gravitational rotation speed")]
    ...
    void Start()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<CharacterController, ModdedPlayerCharacterController>(m_Controller, this, gameObject);

        m_InputHandler = GetComponent<PlayerInputHandler>();
        DebugUtility.HandleErrorIfNullGetComponent<PlayerInputHandler, ModdedPlayerCharacterController>(m_InputHandler, this, gameObject);

        m_WeaponsManager = GetComponent<PlayerWeaponsManager>();
        DebugUtility.HandleErrorIfNullGetComponent<PlayerWeaponsManager, ModdedPlayerCharacterController>(m_WeaponsManager, this, gameObject);

        m_Health = GetComponent<Health>();
        DebugUtility.HandleErrorIfNullGetComponent<Health, ModdedPlayerCharacterController>(m_Health, this, gameObject);

        m_Actor = GetComponent<Actor>();
        DebugUtility.HandleErrorIfNullGetComponent<Actor, ModdedPlayerCharacterController>(m_Actor, this, gameObject);

        m_Rigidbody = GetComponent<Rigidbody>();
        DebugUtility.HandleErrorIfNullGetComponent<Actor, ModdedPlayerCharacterController>(m_Rigidbody, this, gameObject);
    ...
    void GroundCheck()
    {
        ...
        if (Time.time >= m_LastTimeJumped + k_JumpGroundingPreventionTime)
        {
            ...
            if (Physics.SphereCast(GetCapsuleBottomHemisphere(), m_Controller.radius, -transform.up, out RaycastHit hit, chosenGroundCheckDistance, groundCheckLayers, QueryTriggerInteraction.Ignore))
            {
    ...
    void ApplyGravity()
    {
        if(gravityField)
        {
            ...
            gravityDownForce = gravityField.Gravity;
        }
    }
